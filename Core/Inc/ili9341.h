...
#define LCD_S_CS	LL_GPIO_SetOutputPin(LCD_CS_PORT, LCD_CS_PIN);
#define LCD_U_CS	LL_GPIO_ResetOutputPin(LCD_CS_PORT, LCD_CS_PIN);
#define LCD_S_DC	LL_GPIO_SetOutputPin(LCD_CS_PORT, LCD_DC_PIN);
#define LCD_U_DC	LL_GPIO_ResetOutputPin(LCD_CS_PORT, LCD_DC_PIN);
#define LCD_S_RST	LL_GPIO_SetOutputPin(LCD_CS_PORT, LCD_RST_PIN);
#define LCD_U_RST	LL_GPIO_ResetOutputPin(LCD_CS_PORT, LCD_RST_PIN);
...
void LCD_FontRw(uint16_t x, uint16_t y, const char *text, const char *textRw, const GFXfont *p_font, uint8_t size, uint32_t color24, uint32_t color24Rw);
